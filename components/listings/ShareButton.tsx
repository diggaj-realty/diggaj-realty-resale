...
export default function ShareButton({ title }: { title: string }) {
  ...
  return (
    <button
      onClick={share}
      className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-medium text-ink shadow-sm ring-1 ring-ink/10 transition-transform hover:-translate-y-px"
    >
