...
export default async function SellerInterestDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  return (
    <div>
      <Link href="/dashboard/seller/interests" className="text-xs font-medium text-ink/70 underline underline-offset-2">
