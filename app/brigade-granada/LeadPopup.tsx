...
const SESSION_KEY = "brigade-granada-lead-popup-shown";

/** Fires once, 7s after the page mounts, and never again this session — a
 *  popup that reappears on every back/forward navigation is just noise. */
        ...
        >
          ...
          >
            ...
            <h2 className="mt-3 text-xl font-medium tracking-[-0.02em] text-white">
              Get the Brigade Granada price sheet
            </h2>
            <p className="mt-3 text-sm text-white/60">
              Leave your details and an advisor will send configurations, pricing and the payment
              plan.
            </p>
